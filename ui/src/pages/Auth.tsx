      ...
      <div className="w-full md:w-1/2 flex flex-col overflow-y-auto">
        <div className="w-full max-w-md mx-auto my-auto px-8 py-12">
          ...
          <h1 className="text-xl font-semibold">
            {mode === "sign_in" ? t("auth.sign_in_to_paperclip") : t("auth.create_account")}
          </h1>
          ...
          >
            {mode === "sign_up" && (
              <div>
                <label className="text-xs text-muted-foreground mb-1 block">{t("auth.name")}</label>
                <input
          ...
          <div className="mt-5 text-sm text-muted-foreground">
            {mode === "sign_in" ? t("auth.need_account") : t("auth.have_account")}{" "}
            <button
              type="button"
            ...
            >
              {mode === "sign_in" ? t("auth.create_one") : t("auth.sign_in")}
            </button>
          </div>
        </div>
      </div>

        ...
        <>
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {data.agents.running} {t("dashboard.metrics.running")}{", "}
                  {data.agents.paused} {t("dashboard.metrics.paused")}{", "}
                  {data.agents.error} {t("dashboard.metrics.errors")}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.tasks.open} {t("dashboard.metrics.open")}{", "}
                  {data.tasks.blocked} {t("dashboard.metrics.blocked")}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% ${t("dashboard.metrics.of_budget").replace("{{budget}}", formatCents(data.costs.monthBudgetCents))}`
            ...
            <MetricCard
              ...
              description={
                <span>
                  {data.staleTasks} {t("dashboard.metrics.stale_tasks")}
                </span>
              }
            />
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <ChartCard title={t("dashboard.charts.issues_by_priority")} subtitle={t("dashboard.charts.last_14_days")}>
              <PriorityChart issues={issues ?? []} />
            </ChartCard>
            <ChartCard title={t("dashboard.charts.issues_by_status")} subtitle={t("dashboard.charts.last_14_days")}>
